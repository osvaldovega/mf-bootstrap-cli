...
export const cliHelp = () => {
	console.log(`\n  ${greenBold('Options:')} \n`);
	console.log('  -h, --help           \tprint mf-generator-cli command line options (currently set)');
...
export const nodeVersionError = (currentNodeVersion) => {
	...
	console.error(`\t${blue('Micro-Frontend Bootstrap (mf-generator-cli)')} requires ${greenBold('Node 10')} or higher`);
